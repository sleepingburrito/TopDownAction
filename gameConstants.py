...
#scene
#=================
SCENE_BASE_DIRECTORY = "maps"

#json keywords
SCENE_JSON_LAYER_WALLS = "Walls"
SCENE_JSON_LAYER_OBJECTS = "MainObjects"
SCENE_JSON_PLAYER_SPAWN = "playerSpawn"

#map files
SCENE_MAP_TEST = "test.json"
